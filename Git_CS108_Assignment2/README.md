...
1. This program creates two objects of class Dog. 
2. It uses default constructor and parameterized constructor to initialize two different dog objects dilbert and tommy respectively. 
3. then calls display method to print out data of these Dogs. 
4. Program uses setter and getter methods to assign values to instance variables and to access instance variables respectively.
