...
## File manifest
  - README.md
  - InvalidNumberOfTicketsException.java
  - SuperLottoPlus.java
  - index.html (JavaDoc file inside Doc folder)
   
## Project Description

1. Program generates SuperLotto lottery tickets as per user's requirement and 
   prints those tickets to the lottery.txt file.
2. Program handles different exceptions when user enters any invalid value for number of tickets he/she wants.
3. Program also handles IOexception when it fails to create a file or to close the file.
